                                        ...
                                        <div className="space-y-4 p-5 rounded-xl bg-orange-50 border border-orange-100 shadow-sm group">
                                            ...
                                            <div className="space-y-4">
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    <Input value={data.carteira_digital_senha || ''} onChange={(e) => setData({ ...data, carteira_digital_senha: e.target.value })} type="text" autoComplete="off" className="bg-white border-orange-200/50 focus-visible:ring-orange-500" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
