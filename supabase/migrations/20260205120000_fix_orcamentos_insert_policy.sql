...
CREATE POLICY "orcamentos_manage_policy_v5"
...
-- Create permissive policy for authenticated users (Select, Insert, Update, Delete)
CREATE POLICY "anexos_orcamentos_manage_policy_v5"
...
DROP POLICY IF EXISTS "orcamentos_bucket_insert_policy_v4" ON storage.objects;
DROP POLICY IF EXISTS "orcamentos_bucket_select_policy_v4" ON storage.objects;
DROP POLICY IF EXISTS "orcamentos_bucket_update_policy_v4" ON storage.objects;
DROP POLICY IF EXISTS "orcamentos_bucket_delete_policy_v4" ON storage.objects;
...
CREATE POLICY "orcamentos_bucket_insert_policy_v5"
ON storage.objects FOR INSERT
TO authenticated
WITH CHECK (bucket_id = 'orcamentos');

CREATE POLICY "orcamentos_bucket_select_policy_v5"
ON storage.objects FOR SELECT
TO public
USING (bucket_id = 'orcamentos');

CREATE POLICY "orcamentos_bucket_update_policy_v5"
ON storage.objects FOR UPDATE
TO authenticated
USING (bucket_id = 'orcamentos');

CREATE POLICY "orcamentos_bucket_delete_policy_v5"
